...
public class Doctor_signup_1 extends AppCompatActivity implements View.OnClickListener {

    //Sign Up Class_Doctor Page 1 Variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.doctor_sign_up_1);
    ...
    private void continueSignUp() {
        ...
        //Pass the credential data to Sign Up Class_Doctor Page 2
        //We will only register the doctor tgt with other data in Sign Up Class_Doctor Page 2
        Intent intent = new Intent(Doctor_signup_1.this, Doctor_signup_2.class);
